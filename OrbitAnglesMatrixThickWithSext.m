...
Rin5=[0;0;0;0;1;0];
Rin6=[0;0;0;0;0;1];
Rin=[Rin1,Rin2,Rin3,Rin4,Rin5,Rin6]*eps;
...
%             delta1=ROUT1(5,i);
            ...
            %ring{indBendQuad(i)}.Class
            %this should be a quadrupole or a sextupole
            %passmtd=ring{indBendQuad(i)}.PassMethod;
            %Z0=passmtd(ring{indBendQuad(i)},ROUT0(:,i));
            %Z1=passmtd(ring{indBendQuad(i)},ROUT1(:,i));
