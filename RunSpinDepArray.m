...
for indproc=1:nproc %
    ...
    % prepare OAR script to run 
    % put here the matlab version you are using
    script=[...
        ' /cvmfs/comm.esrf.fr/software/packages/ubuntu24.04/x86_64/matlab/R2024b '...
        fullfile(pwd,spfn) '\n'];
...
disp([num2str(nproc) ' processes with label: ' label ' are running in the cluster ']);
